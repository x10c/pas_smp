...
AS
SELECT
	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '1') AND (A.KD_JENIS_KELAMIN = '1')),1,0)) AS KEP_TU_L
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '1') AND (A.KD_JENIS_KELAMIN = '2')),1,0)) AS KEP_TU_P
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '2') AND (A.KD_JENIS_KELAMIN = '1')),1,0)) AS BENDAHARA_L
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '2') AND (A.KD_JENIS_KELAMIN = '2')),1,0)) AS BENDAHARA_P
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '3') AND (A.KD_JENIS_KELAMIN = '1')),1,0)) AS PETUGAS_INS_L
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '3') AND (A.KD_JENIS_KELAMIN = '2')),1,0)) AS PETUGAS_INS_P
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '4') AND (A.KD_JENIS_KELAMIN = '1')),1,0)) AS LABORAN_L
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '4') AND (A.KD_JENIS_KELAMIN = '2')),1,0)) AS LABORAN_P
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '5') AND (A.KD_JENIS_KELAMIN = '1')),1,0)) AS PERPUS_L
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '5') AND (A.KD_JENIS_KELAMIN = '2')),1,0)) AS PERPUS_P
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '6') AND (A.KD_JENIS_KELAMIN = '1')),1,0)) AS JURU_BENGKEL_L
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '6') AND (A.KD_JENIS_KELAMIN = '2')),1,0)) AS JURU_BENGKEL_P
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '7') AND (A.KD_JENIS_KELAMIN = '1')),1,0)) AS JURU_KETIK_L
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '7') AND (A.KD_JENIS_KELAMIN = '2')),1,0)) AS JURU_KETIK_P
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '8') AND (A.KD_JENIS_KELAMIN = '1')),1,0)) AS PENJAGA_SEK_L
,	SUM(IF(((C.KD_TENAGA_ADMINISTRASI = '8') AND (A.KD_JENIS_KELAMIN = '2')),1,0)) AS PENJAGA_SEK_P
FROM 
	(( T_PEGAWAI 						AS A
    JOIN V_PEGAWAI_JABATAN_AWAL_AKHIR 	AS B)
	JOIN T_PEGAWAI_RWYT_JABATAN 		AS C)
