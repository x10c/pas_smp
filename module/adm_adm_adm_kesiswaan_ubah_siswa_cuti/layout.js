...
var m_adm_adm_adm_kesiswaan_ubah_siswa_cuti;
var m_adm_adm_adm_kesiswaan_ubah_siswa_cuti_d = _g_root +'/module/adm_adm_adm_kesiswaan_ubah_siswa_cuti/';

function M_AdmAdmAdmKesiswaanUbahSiswaCuti(title)
{
	this.title		= title;
	this.dml_type	= 0;
	this.ha_level	= 0;
	...
	this.store = new Ext.data.ArrayStore({
			fields		: this.record
		,	url			: m_adm_adm_adm_kesiswaan_ubah_siswa_cuti_d +'data.jsp'
		,	autoLoad	: false
	});
	...
	this.panel = new Ext.grid.GridPanel({
			id					: 'adm_adm_adm_kesiswaan_ubah_siswa_cuti_panel'
		,	title				: this.title
		,	store				: this.store
		,	sm					: this.sm
	...
	this.do_save = function(record)
	{
		...
		Ext.Ajax.request({
				url		: m_adm_adm_adm_kesiswaan_ubah_siswa_cuti_d +'submit.jsp'
			,	params  : {
...
m_adm_adm_adm_kesiswaan_ubah_siswa_cuti = new M_AdmAdmAdmKesiswaanUbahSiswaCuti('Ubah Siswa Cuti');

//@ sourceURL=m_adm_adm_adm_kesiswaan_ubah_siswa_cuti.layout.js
