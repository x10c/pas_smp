...
try{
	...
	switch (dml) {
	case 2:
		q	=" insert into t_sekolah_perlengkapan_kbm (kd_tahun_ajaran, kd_perlengkapan_sekolah, jumlah, username)"
			+" values ('"+ kd_tahun_ajaran +"', '"+ kd_perlengkapan_sekolah +"', "+ jumlah +", '"+ username +"')";
		break;
	case 3:
		q	=" update	t_sekolah_perlengkapan_kbm"
			+" set		jumlah					= "+ jumlah
			+" ,		username				= '"+ username +"'"
		...
		break;
	case 4:
		q 	= " delete	from t_sekolah_perlengkapan_kbm"
			+ " where	kd_tahun_ajaran			= '"+ kd_tahun_ajaran + "'"
			+ " and		kd_perlengkapan_sekolah	= '"+ kd_perlengkapan_sekolah + "'";
		break;
	default:
