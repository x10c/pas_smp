...
var m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar;
var m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar_d = _g_root +'/module/ref_sekolah_kesiswaan_asal_sekolah_pendaftar/';

function M_RefSekolahKesiswaanAsalSekolahPendaftar(title)
{
	this.title			= title;
	this.dml_type		= 0;
	this.ha_level		= 0;
	...
	this.store = new Ext.data.ArrayStore({
			fields		: this.record
		,	url			: m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar_d +'data.jsp'
		,	autoLoad	: false
	});
	
	this.store_propinsi = new Ext.data.ArrayStore({
			fields		: ['id_pro','nm_propinsi']
		,	url			: m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar_d +'data_propinsi.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_kabupaten = new Ext.data.ArrayStore({
		...
		,	url			: m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar_d +'data_kabupaten.jsp'
		,	idIndex		: 1
		,	autoLoad	: false
	});
	...
	this.store_jenis_sekolah = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar_d +'data_jenis_sekolah.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_status_sekolah = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar_d +'data_status_sekolah.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.panel = new Ext.grid.GridPanel({
			id			: 'ref_sekolah_kesiswaan_asal_sekolah_pendaftar_panel'
		,	title		: this.title
		,	store		: this.store
		,	sm			: this.sm
	...
	this.do_save = function(record)
	{
		...
		Ext.Ajax.request({
			...
			,	url		: m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar_d +'submit.jsp'
...
m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar = new M_RefSekolahKesiswaanAsalSekolahPendaftar('Asal Sekolah Pendaftar');

//@ sourceURL=m_ref_sekolah_kesiswaan_asal_sekolah_pendaftar.layout.js
