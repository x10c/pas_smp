...
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi;
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_master;
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga;
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_list;
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_detail;
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal;
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_list;
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_detail;
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_riwayat_pangkat;
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_riwayat_jabatan;
...
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d = _g_root +'/module/adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi/';
var m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_ha_level = 0;

function m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_master_on_select_load_detail()
{
 	if (typeof m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_master == 'undefined'
	||  typeof m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga == 'undefined'
	||  typeof m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal == 'undefined'
	...
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga.do_refresh();
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal.do_refresh();
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_riwayat_pangkat.do_refresh();
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_riwayat_jabatan.do_refresh();
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran.do_refresh();
}

function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailKeluargaDetail()
{
	this.dml_type	= 0;
	...
	this.store_agama = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_agama.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_gol_darah = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_gol_darah.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	{
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_master.panel.setDisabled(false);

		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.unhideTabStripItem(1);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.unhideTabStripItem(2);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.unhideTabStripItem(3);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.unhideTabStripItem(4);
		
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga.panel.layout.setActiveItem(0);
	}
		...
		Ext.Ajax.request({
			...
			,	success :
					function (response)
					{
						...
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_list.store.reload();
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga.panel.layout.setActiveItem(0);
					}
			,	scope	: this
		});
...
function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailKeluargaList()
{
	...
	this.store = new Ext.data.ArrayStore({
			fields		: this.record
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_detail_keluarga_list.jsp'
		,	autoLoad	: false
	});
	...
	this.sm = new Ext.grid.RowSelectionModel({
		...
		,	listeners	: {
			...
			,	selectionchange	: function(sm) {
					...
					if (data.length){
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_keluarga_no_urut = data[0].data['no_urut'];
						
						if (m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_ha_level == 4) {
							this.btn_del.setDisabled(false);
						}
					} else {
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_keluarga_no_urut = '';
	...
	this.do_edit = function()
	{
		...
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_detail.do_refresh();
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_detail.do_edit(data.get('no_urut'));
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga.panel.layout.setActiveItem(1);
		
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_master.panel.setDisabled(true);

		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.hideTabStripItem(1);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.hideTabStripItem(2);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.hideTabStripItem(3);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.hideTabStripItem(4);
	}
	...
	this.do_add = function()
	{
		...
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_detail.do_add();
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_detail.do_refresh();
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga.panel.layout.setActiveItem(1);
	...
	this.do_refresh = function()
	{
		if (m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_ha_level < 1) {
		...
		if (m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_ha_level < 3) {
			this.btn_edit.setDisabled(true);
		} else {
			this.btn_edit.setDisabled(false);
		}

		if (m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_ha_level >= 2) {
...
function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailKeluarga(title)
{
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_list		= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailKeluargaList();
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_detail	= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailKeluargaDetail();
	...
	this.panel = new Ext.Panel({
		...
		,	autoScroll		: true
		,	items			: [
				m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_list.panel
			,	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_detail.panel
			]
	});
	
	this.do_refresh = function()
	{
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga_list.do_refresh();
	}
}

function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPendidikanFormalDetail()
{
	this.dml_type	= 0;

	this.store_tingkat_ijazah = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_tingkat_ijazah.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_program_studi = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_program_studi.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_akreditasi = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_akreditasi.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.do_back = function()
	{
		...
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.unhideTabStripItem(0);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.unhideTabStripItem(2);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.unhideTabStripItem(3);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.unhideTabStripItem(4);

		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal.panel.layout.setActiveItem(0);		
	}
		...
		Ext.Ajax.request({
			...
			,	success :
					function (response)
					{
						...
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_list.store.reload();
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal.panel.layout.setActiveItem(0);
					}
			,	scope	: this
		});
...
function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPendidikanFormalList()
{
	...
	this.store = new Ext.data.ArrayStore({
			fields		: this.record
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_detail_pendidikan_formal_list.jsp'
		,	autoLoad	: false
	});
	...
	this.sm = new Ext.grid.RowSelectionModel({
		...
		,	listeners	: {
			...
			,	selectionchange	: function(sm) {
					var data = sm.getSelections();
					if (data.length){
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_pendidikan_formal_no_urut = data[0].data['no_urut'];
						
						if (m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_ha_level == 4) {
							this.btn_del.setDisabled(false);
						}
					} else {
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_pendidikan_formal_no_urut = '';
						this.btn_del.setDisabled(true);
					}
				}
			}
	...
	this.do_edit = function()
	{
		...
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_detail.do_refresh();
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_detail.do_edit(data.get('no_urut'));
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal.panel.layout.setActiveItem(1);
		
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_master.panel.setDisabled(true);

		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.hideTabStripItem(0);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.hideTabStripItem(2);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.hideTabStripItem(3);
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.panel_detail.hideTabStripItem(4);
	}
	...
	this.do_add = function()
	{
		...
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_detail.do_add();
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_detail.do_refresh();
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal.panel.layout.setActiveItem(1);
...
function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPendidikanFormal(title)
{
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_list	= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPendidikanFormalList();
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_detail	= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPendidikanFormalDetail();
	...
	this.panel = new Ext.Panel({
		...
		,	autoScroll		: true
		,	items			: [
				m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_list.panel
			,	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_detail.panel
			]
	});
	
	this.do_refresh = function()
	{
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal_list.do_refresh();
	}
}

function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailRiwayatPangkat(title)
{
	this.title		= title;
	this.dml_type	= 0;
	...
	this.store = new Ext.data.ArrayStore({
			fields		: this.record
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_detail_riwayat_pangkat.jsp'
		,	autoLoad	: false
	});
	
	this.store_status_pegawai = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_status_pegawai.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_pangkat = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_pangkat.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.sm = new Ext.grid.RowSelectionModel({
		...
		,	listeners	: {
			...
			,	selectionchange	: function(sm) {
					var data = sm.getSelections();
					if (data.length && m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_ha_level == 4) {
						this.btn_del.setDisabled(false);
					} else {
						this.btn_del.setDisabled(true);
					}
	...
	this.do_save = function(record)
	{
		Ext.Ajax.request({
			...
			,	url		: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'submit_detail_riwayat_pangkat.jsp'
			,	waitMsg	: 'Mohon Tunggu ...'
			,	success :
					function (response)
					{
...
function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailRiwayatJabatan(title)
{
	this.title		= title;
	this.dml_type	= 0;
	...
	this.store = new Ext.data.ArrayStore({
			fields		: this.record
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_detail_riwayat_jabatan.jsp'
		,	autoLoad	: false
	});
	
	this.store_jenis_pegawai = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_jenis_pegawai.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_tenaga_administrasi = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_tenaga_administrasi.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.do_save = function(record)
	{
		Ext.Ajax.request({
			...
			,	url		: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'submit_detail_riwayat_jabatan.jsp'
			,	waitMsg	: 'Mohon Tunggu ...'
			,	success :
					function (response)
					{
...
function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPenataranDetail()
{
	this.dml_type	= 0;

	this.store_penataran = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_penataran.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_penyelenggara_penataran = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_penyelenggara_penataran.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_jenis_penataran = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_jenis_penataran.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.store_jenis_peserta_penataran = new Ext.data.ArrayStore({
			fields		: ['id','name']
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_ref_jenis_peserta_penataran.jsp'
		,	idIndex		: 0
		,	autoLoad	: false
	});
	...
	this.do_back = function()
	{
		...
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran.panel.layout.setActiveItem(0);		
	}
		...
		Ext.Ajax.request({
			...
			,	success :
					function (response)
					{
						...
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_list.store.reload();
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran.panel.layout.setActiveItem(0);
					}
			,	scope	: this
		});
...
function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPenataranList()
{
	...
	this.store = new Ext.data.ArrayStore({
			fields		: this.record
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_detail_penataran_list.jsp'
		,	autoLoad	: false
	});
	...
	this.sm = new Ext.grid.RowSelectionModel({
		...
		,	listeners	: {
			...
			,	selectionchange	: function(sm) {
					var data = sm.getSelections();
					if (data.length){
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_penataran_no_urut = data[0].data['no_urut'];
						
						if (m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_ha_level == 4) {
							this.btn_del.setDisabled(false);
						}
					} else {
						m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_penataran_no_urut = '';
						this.btn_del.setDisabled(true);
					}
				}
			}
	...
	this.do_edit = function()
	{
		...
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_detail.do_refresh();
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_detail.do_edit(data.get('no_urut'));
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran.panel.layout.setActiveItem(1);
	...
	this.do_add = function()
	{
		...
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_detail.do_add();
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_detail.do_refresh();
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran.panel.layout.setActiveItem(1);
...
function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPenataran(title)
{
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_list	= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPenataranList();
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_detail	= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPenataranDetail();
	...
	this.panel = new Ext.Panel({
		...
		,	autoScroll		: true
		,	items			: [
				m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_list.panel
			,	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_detail.panel
			]
	});
	
	this.do_refresh = function()
	{
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran_list.do_refresh();
	}
}

function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiMaster(title)
{
	this.title		= title;
	...
	this.store = new Ext.data.ArrayStore({
			fields		: this.record
		,	url			: m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_d +'data_master.jsp'
		,	autoLoad	: false
	});
...
function M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasi()
{
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_master					= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiMaster('Pemeliharaan Data Induk Tenaga Administrasi');
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga			= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailKeluarga('Keluarga');
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal	= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPendidikanFormal('Pendidikan Formal');
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_riwayat_pangkat	= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailRiwayatPangkat('Riwayat Pangkat');
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_riwayat_jabatan	= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailRiwayatJabatan('Riwayat Jabatan');
	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran			= new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasiDetailPenataran('Penataran');
	...
	this.panel_detail = new Ext.TabPanel({
		...
		,	items			: [
				m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_keluarga.panel
			,	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_pendidikan_formal.panel
			,	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_riwayat_pangkat.panel
			,	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_riwayat_jabatan.panel
			,	m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_detail_penataran.panel
			]
	});

	this.panel = new Ext.Panel({
			id				: 'adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_panel'
		,	layout			: 'border'
		,	bodyBorder		: false
		,	defaults		: {
				loadMask		: {msg: 'Pemuatan...'}
		...
		,	items			: [
				m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_master.panel
			,	this.panel_detail
			]
	});
	...
	{
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_ha_level = ha_level;
		
		m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi_master.do_refresh();
	}
}

m_adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi = new M_AdmPegawaiPemeliharaanDataIndukTenagaAdministrasi();

//@ sourceURL=adm_pegawai_pemeliharaan_data_induk_tenaga_administrasi.layout.js
